      ...
      <div className="p-6 max-w-3xl mx-auto text-white text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
          <Link
            ...
            className="bg-blue-700 hover:bg-blue-800 px-6 py-3 rounded text-sm font-medium"
          >
            🎨 Explore Templates
          </Link>
          <Link
            href="/early-access"
            className="bg-zinc-800 hover:bg-zinc-700 px-6 py-3 rounded text-sm font-medium"
          >
            🔐 Get Early Access
          </Link>
          <Link
