  ...
  return (
    <>
      ...
      <div className="p-6 max-w-xl mx-auto text-white text-center">
        ...
        <p className="text-zinc-400 mb-4">Your signal has been received. We’ll be in touch soon.</p>

        {ref && (
          <div className="bg-zinc-800 rounded p-4 mt-6 text-left text-sm">
            <h2 className="text-white text-base font-semibold mb-2">📡 Attribution Info</h2>
