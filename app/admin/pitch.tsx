      ...
      <div className="max-w-3xl mx-auto space-y-10">
        ...
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-5 space-y-1 text-sm text-gray-300">
            <li>
              <strong>Visual Editor</strong>: Edit any Zod schema and preview live
            </li>
            <li>
              <strong>Deploy & Share</strong>: Render sites with ?params or ?schema_id
            </li>
            <li>
            ...
            <li>
              <strong>Slack/Supabase</strong>: Optional workflows and persistence
            </li>
          </ul>
        </div>
