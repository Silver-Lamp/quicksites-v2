...
//
// Admin surface for the Talking Demo generator: pick any built site (slug or id) and generate its
...
export default async function AdminTalkingDemoPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-10">
      ...
      <h1 className="text-2xl font-semibold tracking-tight">Generate a Talking Demo</h1>
