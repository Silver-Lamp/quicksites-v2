...
const ROWS: Row[] = [
  ...
  {
    feature: 'Rich, industry-specific block library',
    detail: 'Purpose-built sections beyond generic widgets — menus, estimators, galleries, audio',
    qs: { mark: 'yes', note: 'Menu/ordering, estimator, before-after, gallery, events, audio + more — added per vertical' },
    duda: { mark: 'partial', note: 'Broad generic widgets; not trade-specific' },
    ghl: { mark: 'no', note: 'Funnels/pages, thin section library' },
  },
  {
    feature: 'Instant quote / estimator widget',
    detail: 'A homeowner enters dimensions → live price range on the page → captured as a lead',
    qs: { mark: 'yes', note: '9-trade estimator (deck, fence, concrete, roofing…) — real math, lead capture' },
    duda: { mark: 'no', note: 'Custom code / third-party only' },
    ghl: { mark: 'no', note: 'Not offered' },
  },
  {
    feature: 'Owner-voice audio ("About That")',
    detail: 'The owner/agent talks about the business or listing — a real voice, not stock copy',
    qs: { mark: 'yes', note: 'Audio blocks + QR "listen" pack for signs/flyers' },
    duda: { mark: 'no', note: 'Not offered' },
    ghl: { mark: 'no', note: 'Not offered' },
  },
  {
    feature: 'Ambient screensaver wow-factor',
    detail: 'A fireplace (or any image/video) fades in when a visitor steps away, dissolves on return',
    qs: { mark: 'yes', note: 'Toggle-on per site; fireplace preset or your own asset' },
    duda: { mark: 'no', note: 'Not offered' },
    ghl: { mark: 'no', note: 'Not offered' },
  },
  {
