...
const DEFAULT_ORG: Org = {
  ...
  slug: 'quicksites',
  name: 'QuickSites',
  logo_url: '/brand/qs-mark.png',
  dark_logo_url: '/brand/qs-mark.png',
  favicon_url: null,
  theme_json: {},
...
export function useBrand() {
  ...
  return {
    name: org.name,
    slug: org.slug,
    logoUrl: org.logo_url ?? '/brand/qs-mark.png',
    darkLogoUrl: org.dark_logo_url ?? org.logo_url ?? '/brand/qs-mark.png',
