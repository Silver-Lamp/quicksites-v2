...
import type { JsonValue } from '@/admin/types/json';
...
export default function TemplateJsonEditor({ rawJson, setRawJson }: TemplateJsonEditorProps) {
  ...
  const renderValue = (value: JsonValue, path = '') => {
    ...
    if (type === "boolean") return <span className="text-orange-400">{(value as boolean).toString()}</span>;
    ...
    <div className="space-y-2">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <Button variant="secondary" size="sm" onClick={handlePrettify}>Prettify</Button>
