      ...
      {show && (
        <ModalContext.Provider value={{ labelId }}>
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <motion.div
              ref={modalRef}
              className="relative z-10 bg-white text-black dark:bg-neutral-900 dark:text-white rounded-lg shadow-xl w-full max-w-lg max-h-[90vh] flex flex-col"
              role="dialog"
              aria-modal="true"
            ...
            >
              ...
              {/* Footer */}
              <div className="border-t border-gray-200 dark:border-neutral-700 bg-gray-100 dark:bg-neutral-800 px-6 py-4 flex justify-end gap-2 sticky bottom-0 z-10">
                <button
                  onClick={onClose}
