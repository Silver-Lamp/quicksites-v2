...
export const EVENTS = {
  ...
  // Someone scanned a trade-site claim postcard's QR (/go/<prospectId>). The prospect row also
  // counts it (claim_link_visits); this is the PostHog mirror so the funnel is visible there too.
  TRADE_CARD_LINK_VISITED: 'trade_card_link_visited',
