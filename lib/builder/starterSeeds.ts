...
const STARTER_NAMES: Partial<Record<IndustryKey, string>> = {
  ...
  fencing: 'Cedar Line Fence Co.',
  concrete: 'Cornerstone Concrete',
  turf: 'Evergreen Turf & Greens',
  epoxy_flooring: 'IronCoat Epoxy Floors',
  paving: 'Blacktop Pro Paving',
  roofing: 'Summit Ridge Roofing',
  siding: 'ClearView Siding Co.',
  retaining_walls: 'Stoneworks Retaining Walls',
