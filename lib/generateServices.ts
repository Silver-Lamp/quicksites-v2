...
const SERVICE_NAMES: Partial<Record<IndustryKey, string[]>> = {
  ...
  fencing: ['Wood & Vinyl Fencing', 'Chain-Link & Aluminum', 'Gates & Access', 'Fence Repair', 'Free Estimates'],
  concrete: ['Concrete Patios', 'Driveways & Walkways', 'Stamped & Colored Concrete', 'Slabs & Flatwork', 'Free Estimates'],
  turf: ['Artificial Lawn Turf', 'Putting Greens', 'Pet & Playground Turf', 'Turf Repair', 'Free Estimates'],
  epoxy_flooring: ['Garage Floor Coatings', 'Metallic & Flake Epoxy', 'Commercial Floors', 'Grind & Prep', 'Free Estimates'],
  paving: ['Asphalt Paving', 'Driveways & Lots', 'Sealcoating', 'Paver Installation', 'Free Estimates'],
