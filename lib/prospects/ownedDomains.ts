...
const SERVICE_ALIASES: Partial<Record<IndustryKey, string[]>> = {
  ...
  fencing: ['fence', 'fencing', 'fences', 'fencecontractor', 'fenceco', 'fencebuilder'],
  concrete: ['concrete', 'concretecontractor', 'concreteco', 'flatwork', 'cement'],
  turf: ['turf', 'artificialturf', 'syntheticturf', 'turfinstall', 'puttinggreens'],
  epoxy_flooring: ['epoxy', 'epoxyflooring', 'epoxyfloors', 'garagefloor', 'garagefloors', 'floorcoating'],
  paving: ['paving', 'paver', 'pavers', 'asphalt', 'asphaltpaving', 'pavingco'],
  roofing: ['roofing', 'roofer', 'roofers', 'roofreplacement', 'roofrepair', 'newroof', 'roofingco'],
  siding: ['siding', 'sidingcontractor', 'sidingco', 'exteriors', 'sidinginstall'],
  retaining_walls: ['retainingwall', 'retainingwalls', 'hardscape', 'hardscaping', 'retainingwallco'],
