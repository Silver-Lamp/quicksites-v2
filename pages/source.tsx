  ...
  return (
    <div className="max-w-2xl mx-auto p-6 text-white">
      ...
      <ul className="space-y-3 text-sm text-zinc-400">
        <li>🔗 <a href="https://github.com/Silver-Lamp/quicksites-v2" className="underline">View Source on GitHub</a></li>
      ...
      <p className="text-xs text-zinc-600 mt-6">If you improve this, let us know. If you fork it, we wish you sunlight.</p>
    </div>
  );
}
